...
AudioSynthWaveformSine   sine1;          //xy=126,219
AudioFilterFIR           shw;            //xy=290,270
AudioInputI2S            mic;            //xy=321,555
AudioAdaptiveFxFIR       adaptive_fx_fir1; //xy=488,285
AudioFilterFIR           pw;             //xy=561,219
AudioFilterFIR           sw;             //xy=640,287
AudioMixer4              mixer1;         //xy=811,223
AudioOutputI2S           headphone;      //xy=1012,417
AudioConnection          patchCord1(sine1, pw);
AudioConnection          patchCord2(sine1, shw);
AudioConnection          patchCord3(sine1, 0, headphone, 1);
...
AudioControlSGTL5000     sgtl5000_1;     //xy=634,92
